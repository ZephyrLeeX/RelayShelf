...
.topbar { height:68px; position:sticky; top:0; z-index:20; display:grid; grid-template-columns:auto minmax(240px,560px) auto; gap:1rem; align-items:center; padding:.65rem max(1rem, calc((100vw - 1180px)/2)); background:color-mix(in srgb, var(--surface-raised) 92%, transparent); border-bottom:1px solid var(--border); backdrop-filter:blur(14px); }
