...
<style scoped>
.app-topbar{grid-column:2/-1;display:grid;grid-template-columns:minmax(170px,1fr) minmax(0,560px) minmax(170px,1fr);align-items:center;gap:1rem;min-width:0;padding:.75rem 1rem;border-bottom:1px solid var(--border-default);background:color-mix(in srgb,var(--surface-raised) 91%,transparent);backdrop-filter:blur(16px)}
...
.topbar-actions{grid-column:3;display:flex;align-items:center;justify-content:flex-end;justify-self:stretch;gap:.6rem;min-width:0;overflow:visible}
</style>
